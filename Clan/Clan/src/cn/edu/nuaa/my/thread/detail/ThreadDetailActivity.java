package cn.edu.nuaa.my.thread.detail;
...
import cn.edu.nuaa.my.base.json.threadview.Report;
...
import cn.edu.nuaa.my.thread.ThreadReportActivity;
import cn.edu.nuaa.my.thread.detail.menu.DetailMenuFragment;
import cn.edu.nuaa.my.thread.detail.reply.QuickReplyFragment;
import cn.edu.nuaa.my.threadandarticle.ZhaoHandler;
...
//            webFragment.getWebView().loadUrl("http://192.168.180.23:8080/gaofy/#/posts_detail?bigapp_device=android");
    ...
    private String getFavid() {
        ...
        if (getVariables() != null) {
            ...
            cn.edu.nuaa.my.base.json.favthread.Thread favThread = MyFavUtils.getFavThreadById(this, thread.getTid());
