package cn.edu.nuaa.my.act.manage;
...
import cn.edu.nuaa.my.base.json.ActPlayerJson;
import cn.edu.nuaa.my.base.json.act.ActPlayer;
...
public class AdapterActManage extends BaseRefreshAdapter<ActPlayerJson> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        final CheckBox cb_item = cn.edu.nuaa.my.base.widget.ViewHolder.get(convertView, R.id.cb_item);
        TextView tv_name = cn.edu.nuaa.my.base.widget.ViewHolder.get(convertView, R.id.tv_name);
        TextView tv_time = cn.edu.nuaa.my.base.widget.ViewHolder.get(convertView, R.id.tv_time);
        TextView tv_status = cn.edu.nuaa.my.base.widget.ViewHolder.get(convertView, R.id.tv_status);
        TextView tv_desc = cn.edu.nuaa.my.base.widget.ViewHolder.get(convertView, R.id.tv_desc);
        TextView tv_more = cn.edu.nuaa.my.base.widget.ViewHolder.get(convertView, R.id.tv_more);
        View v_margin_bottom = cn.edu.nuaa.my.base.widget.ViewHolder.get(convertView, R.id.v_margin_bottom);
