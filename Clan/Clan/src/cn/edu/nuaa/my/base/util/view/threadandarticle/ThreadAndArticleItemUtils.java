...
import cn.edu.nuaa.my.base.json.article.ReadArticle;
import cn.edu.nuaa.my.base.json.forumdisplay.Thread;
import cn.edu.nuaa.my.base.json.forumnav.NavForum;
import cn.edu.nuaa.my.base.json.thread.BaseThread;
import cn.edu.nuaa.my.base.json.thread.ReadThread;
...
import cn.edu.nuaa.my.threadandarticle.ForumNameOCL;
...
public class ThreadAndArticleItemUtils extends ContentUtils {
     ...
     * @param tvForumName
     */
    public static void setForumName(Context context, cn.edu.nuaa.my.base.json.forumdisplay.Thread thread, TextView tvForumName) {
